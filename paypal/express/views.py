...
class SuccessResponseView(PaymentDetailsView):
    ...
    def get_shipping_address(self, basket):
        ...
        if len(parts) == 1:
            ...
            # Check if name has "(company_name)" at the end of the string.
            if re.search(".*[(].*[)]$", ship_to_name):
                index_of_open = ship_to_name.rfind("(")
                index_of_close = ship_to_name.rfind(")")
                company = ship_to_name[index_of_open + 1 : index_of_close]
